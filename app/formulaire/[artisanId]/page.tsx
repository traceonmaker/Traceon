    ...
    <Shell>
      <div style={{maxWidth:400,margin:'0 auto',width:'100%'}}>
        <div style={{textAlign:'center',marginBottom:30}} className="a-fadeUp">
          <div style={{width:54,height:54,borderRadius:16,background:'linear-gradient(135deg,#2a63de,#1550cf)',display:'flex',alignItems:'center',justifyContent:'center',margin:'0 auto 12px',boxShadow:'var(--shadow-blue)'}}>
        ...
        {step===4 && (
          <div className="a-fadeUp">
            ...
            {prix && (
              <div style={{background:'linear-gradient(135deg,#2a63de,#1550cf)',borderRadius:18,padding:'20px 16px',marginBottom:20,textAlign:'center',color:'#fff',boxShadow:'var(--shadow-blue)'}}>
